<template>
  <div class="flex justify-between px-7 py-5">
    ...
    <button @click="toggleDark()">
        <svg v-if="isDark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
  ...
  <!-- <div class="bg-gradient-to-r from-teal-700 to-teal-500 rounded-md h-48 mx-3">
    ...
    <div class="p-3">
      ...
      <span class="font-sans text-white text-sm">Akses Dengan Mudah Kapanpun Dan Dimanapun</span>
    </div>
  </div>
  ...
  <div
    ...
    <p class="font-sans text-xs text-slate-600">
      ...
      <span class="font-sans text-sm font-semibold text-slate-600">(H.R.At-Tirmidzi)</span>
    </p>
  </div> -->
</template>
